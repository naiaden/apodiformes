...
apodiformes: src/Apodiformes.cpp src/KneserNey.cpp
	g++ -std=c++0x -o apodiformes src/Apodiformes.cpp src/VectorSpaceModel.cpp src/Document.cpp src/KneserNey.cpp src/File.cpp src/Common.cpp -I/home/lonrust/Software/apodiformes/include -I/home/lonrust/Software/colibri-core/include -L/home/lonrust/Software/colibri-core/src/.libs -lcolibricore -lbz2
